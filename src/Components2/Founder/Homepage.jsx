...
export default function VertxInterface() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-['Manrope']">
      ...
      <div className="pt-16 flex">
        {/* Left Sidebar */}
        <nav className="w-[20%] fixed left-0 top-16 pt-5 bottom-0 border-r-4 border-zinc-800 flex flex-col justify-between bg-black z-40">
          <div>
            {navItems.map((item) => {
              const Icon = item.icon
              return (
        ...
        {/* Right Sidebar */}
        <aside className="w-[32.75%] fixed pt-5 right-0 top-16 bottom-0 border-l-4 border-zinc-800 bg-black z-40">
          <div className="p-4 h-full">
            <div className="bg-zinc-900 rounded-full p-3 flex items-center gap-2">
              <Search className="h-5 w-5 text-zinc-400" />
              <input type="text" placeholder='Ask "Geet"' className="bg-transparent outline-none flex-1" />
