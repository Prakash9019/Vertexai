...
//       {/* Header */}
//       <header className="border-b-2 border-zinc-800 p-4 fixed top-0 w-full bg-black z-50">
...
//         {/* Left Sidebar */}
//         <nav className="w-1/5 fixed h-screen">
//           {navItems.map((item) => {
...
//           <button className="w-full mt-32 rounded-full bg-white text-black py-3 font-bold">Flow</button>

//           <button className="w-full mt-2 rounded-full border border-zinc-700 py-3 flex items-center justify-center gap-2">
...
//         {/* Main Content */}
//         <main className="w-3/5 ml-64 border-x-2 border-zinc-800 min-h-screen">
//           {/* Post Creation */}
...
//         {/* Right Sidebar */}
//         <div className="w-1/4 fixed right-0 h-screen m-2">
...
export default function VertxInterface() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-['Manrope']">
      {/* Header */}
      <header className="border-b-4 border-zinc-800 p-4 fixed top-0 w-full bg-black z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <img
            src={logo1}
              alt="Vertx Logo"
      ...
      <div className="max-w-7xl mx-auto pt-16 flex">
        {/* Left Sidebar */}
        <nav className="w-64 fixed h-screen border-r-4 border-zinc-800 flex flex-col justify-between">
          <div className="p-4">
            {navItems.map((item) => {
              const Icon = item.icon
              return (
        ...
        {/* Main Content */}
        <main className="flex-1 ml-64 mr-80 border-x-4 border-zinc-800 min-h-screen">
          {/* Post Creation */}
        ...
        {/* Right Sidebar */}
        <aside className="w-80 fixed right-0 top-16 bottom-0 border-l-4 border-zinc-800">
          <div className="p-4">
            <div className="bg-zinc-900 rounded-full p-3 flex items-center gap-2">
              <Search className="h-5 w-5 text-zinc-400" />
              <input type="text" placeholder='Ask "Geet"' className="bg-transparent outline-none flex-1" />
